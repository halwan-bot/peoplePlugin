    ...
    angular
        ...
        .factory("DB", ['Buildfire', '$q', 'MESSAGES', 'CODES', function (Buildfire, $q, MESSAGES, CODES) {
            ...
            DB.prototype.get = function () {
                ...
                Buildfire.publicData.get(that._tagName, function (err, result) {
            ...
            DB.prototype.getById = function (id) {
                var that = this;
                var deferred = $q.defer();
                Buildfire.publicData.getById(id, that._tagName, function (err, result) {
                    if (err) {
                        return deferred.reject(err);
                    }
            ...
            DB.prototype.insert = function (items) {
                ...
                if (Array.isArray(items)) {
                    Buildfire.publicData.bulkInsert(items, that._tagName, function (err, result) {
                        if (err) {
                            return deferred.reject(err);
                        }
                        else if (result) {
                    ...
                    Buildfire.publicData.insert(items, that._tagName, false, function (err, result) {
                        if (err) {
                            return deferred.reject(err);
                        }
                        else if (result) {
            ...
            DB.prototype.find = function (options) {
                ...
                Buildfire.publicData.search(options, that._tagName, function (err, result) {
                    if (err) {
                        return deferred.reject(err);
                    }
                    else if (result) {
            ...
            DB.prototype.update = function (id, item) {
                ...
                Buildfire.publicData.update(id, item, that._tagName, function (err, result) {
                    if (err) {
                        return deferred.reject(err);
                    }
                    else if (result) {
            ...
            DB.prototype.save = function (item) {
                ...
                Buildfire.publicData.save(item, that._tagName, function (err, result) {
                    if (err) {
                        return deferred.reject(err);
                    }
                    else if (result) {
            ...
            DB.prototype.delete = function (id) {
                ...
                Buildfire.publicData.delete(id, that._tagName, function (err, result) {
                    if (err) {
                        return deferred.reject(err);
                    }
                    else if (result) {
