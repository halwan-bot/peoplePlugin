...
(function (angular, window) {
  angular
    ...
    .controller('WidgetHomeCtrl', ['$scope', '$window', 'Buildfire', 'TAG_NAMES', 'ERROR_CODE', "Location", '$sce', 'PeopleInfo', '$rootScope',
      function ($scope, $window, Buildfire, TAG_NAMES, ERROR_CODE, Location, $sce, PeopleInfo, $rootScope) {
              ...
              case TAG_NAMES.PEOPLE_INFO:
                if (event.obj) {
                  ...
                  if (event.obj.content) {
                    ...
                    if (view && WidgetHome.data.content) {
                      view.loadItems(WidgetHome.data.content.images);
                    }
                  }
                  if (event.obj.content && event.obj.content.sortBy && currentSortOrder != event.obj.content.sortBy) {
